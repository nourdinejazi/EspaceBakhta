  ...
  return (
    <div>
        ...
        <div className='flex flex-col w-full font-quick    items-center mb-32  '>
            ...
            <div className=' w-3/4 flex  flex-col gap-16 lg:text-justify ' 	  >
                <p>
                ...
                Ces offres peuvent être personnalisées en fonction de vos besoins et de votre budget. Les organisateurs de l'espace Bakhta peuvent travailler avec vous pour créer une offre qui répond à vos attentes et qui assure la réussite de votre événement , pour tout informations complémentaires appelez nous sur <span className='underline text-yellow-600'>Tél 23 737 915</span>.
                </p>
            </div>
        </div> 
        <Footer></Footer>
